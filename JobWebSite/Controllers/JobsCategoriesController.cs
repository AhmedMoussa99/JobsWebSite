...
namespace JobWebSite.Controllers
{
    ...
    public class JobsCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryName,CategoryDescription")] JobsCategory jobsCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryName,CategoryDescription")] JobsCategory jobsCategory)
        {
            if (ModelState.IsValid)
            {
